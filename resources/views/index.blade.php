            ...
            <div class="w-2/5 h-full hidden sm:block">
                <div class='flex h-screen justify-center  container mx-auto'>
                    <div class='mt-12 ml-10'>
                        <div>
                            <select class="select w-56 p-2  text-slate-600 mt-7 rounded-3xl">
                                <option >職種</option>
                                <option>エンジニア</option>
                                <option>デザイナー</option>
                        ...
                        <div class='mt-8 '>
                            <h2 class='text-xl font-bold p-2'>特徴</h2>
                            <ul class='text-xl text-slate-700'>
                                <li class='mt-2 hover:border-b-2'>スタートアップ</li>
                                <li class='mt-2 hover:border-b-2'>ベンチャー</li>
                                <li class='mt-2 hover:border-b-2'>未経験OK</li>
                                <li class='mt-2 hover:border-b-2'>経験者優遇</li>
                                <li class='mt-2 hover:border-b-2'>ポテンシャル採用</li>
                                <li class='mt-2 hover:border-b-2'>内定直結</li>
                                <li class='mt-2 hover:border-b-2'>オンライン可能</li>
                                <li class='mt-2 hover:border-b-2'>週３からOK</li>
                            </ul>
                        </div>
                    </div>
                </div>
