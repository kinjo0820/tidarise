        ...
        <div class='w-[800px]  mx-2 bg-white '>
            <div class="">
                ...
                <div class="flex justify-end">
                    <a href="" class="items-end">
                        <button type="submit" class="text-sm text-orange-500 hover:text-orange-950 px-4">
                            編集する
                        </button>
                    </a>
                </div>
                ...
                <div class="md:px-4">
                    <div class='bg-slate-50 py-3 px-6'>
                        <h2 class='font-bold leading-relaxed  text-xl bg-white'></h2>
                        <p>
